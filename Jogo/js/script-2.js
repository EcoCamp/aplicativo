...
function frame25() {
    ...
    quadro2.src = "img2/13.jpg"
    setTimeout(function () {
        quadro2.style.display = "block";
    }, 600)

    setTimeout(function () {
        quadro.src = "img2/13.jpg";
        quadro2.style.display = "none";
        quadro2.style.opacity = "0";
    }, 900)

    setTimeout(function () {
        quadro2.src = "img2/14.jpg";
        quadro2.style.display = "block";
    }, 1200)

    setTimeout(function () {
        quadro2.src = "img2/15.jpg";
        quadro.src = "img2/15.jpg";
    }, 2200)
...
function finalBom(){
    ...
    setTimeout(function () {
        quadro2.src = "img2/18.jpg";
        quadro.src= "img2/17.jpg"
...
function finalRuim(){
    ...
    setTimeout(function () {
        document.getElementById("opcoes").style.display ="none";
        quadro.src= "img2/16-2.jpg"
        quadro2.src = "img2/17-2.jpg";
    }, 620)
    ...
    setTimeout(function () {
        quadro2.src = "img2/19.jpg";
        quadro.src= "img2/20.jpg";
